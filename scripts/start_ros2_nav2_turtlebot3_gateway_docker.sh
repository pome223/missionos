...
docker run -d \
  ...
  -e "MISSIONOS_MISSION_ASSURANCE_ADK_ENABLED=1" \
  ...
  -e GATEWAY_API_KEY \
  -e "MISSIONOS_ASSURANCE_POLICY_DB=${MISSIONOS_ASSURANCE_POLICY_DB:-}" \
  ...
  -e "MISSIONOS_TURTLEBOT3_RECOVERY_PLAN_ONLY_RETRY_COUNT=${MISSIONOS_TURTLEBOT3_RECOVERY_PLAN_ONLY_RETRY_COUNT:-2}" \
  ...
  -e "MISSIONOS_TURTLEBOT3_SIMULATE_POST_RECOVERY_ROUTE_FAILURE_ONCE=${MISSIONOS_TURTLEBOT3_SIMULATE_POST_RECOVERY_ROUTE_FAILURE_ONCE:-}" \
