...
| VLA-0 | The pinned official runner completed the nominal LIBERO-10 task in 1/1 positive control within the official 520-action limit | After the second pot was moved approximately 22.7 cm, one governed 520-action Repair ended at the same `[true, false, true]` predicate vector | This is one scripted-fixture observation, not a natural-failure or general recovery rate |
...
- The minimum measured end-effector distance to the displaced target pot was
  approximately 54.6 cm.
- Target-pot contact was observed on 0 of 520 steps.
- The recorded frames show the arm moving on the right side of the workspace;
  no target-directed approach, grasp, or transport was observed.
- The already satisfied first-pot and stove predicates were maintained.
- No second attempt was authorized.

[![Annotated VLA-0 LIBERO Repair video: target pot displaced 22.7 cm, 520 simulator steps, no target-directed approach observed](../assets/vla0-libero-clear-fixture-repair-poster.png)](../assets/vla0-libero-clear-fixture-repair.mp4)
...
> VLA-0 completed one nominal official-runner control, but this checkpoint,
> observation, and instruction did not generate a target-directed recovery
> trajectory after the target object was displaced approximately 22.7 cm in a
> mid-episode partial-success state.

The failure was not close to the completion threshold: the policy never moved
toward or contacted the target. This weakens “the 520-action budget was merely
too short” as the primary explanation, although one run cannot prove that a
larger budget would never help.

The leading explanation is a mid-episode distribution shift. VLA-0 could carry
out one nominal episode, but did not replan around a large object-only change
after partial success. This explanation remains an inference, not a proven
mechanism.
