  ...
  <script>
    ...
    function render() {{
      ...
      factsEl.innerHTML = [
        ...
        ["Core feasibility", `candidate=${{statusText(recovery.core_action_feasibility_status)}} · predispatch=${{statusText(recovery.core_predispatch_revalidation_status)}} · adapter=${{statusText(recovery.core_adapter_id)}}`],
